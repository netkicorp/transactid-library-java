...
internal class TransactIdTest {
    ...
    fun `Change status from OK to CANCEL to InvoiceRequest`() {
        ...
        val updatedInvoiceRequestBinary = transactId.changeStatusMessageProtocol(invoiceRequestBinary, newStatusCode, newStatusMessage)
    ...
    fun `Change status from OK to CERTIFICATE_EXPIRED to PaymentRequest Encrypted`() {
        ...
        val newStatusMessage = "Random cancel"
        val updatedPaymentRequestBinary = transactId.changeStatusMessageProtocol(paymentRequestBinary, newStatusCode, newStatusMessage)
        val updatedPaymentRequest = transactId.parsePaymentRequest(updatedPaymentRequestBinary, RECIPIENTS_PARAMETERS_WITH_ENCRYPTION)
